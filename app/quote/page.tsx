						...
						<div className={styles.quote__devider}>
							...
							<div className={styles.quote__about_text}>
								<p style={{ marginBottom: '1.5rem' }}>
									Are you ready to take your business to the next level? Whether
									you have questions, require more information, or are
									interested in a free quote, don&apos;t hesitate to get in
									touch. We&apos;re committed to providing timely responses, and
									you can expect to hear from us within 24 hours. Let&apos;s
									start the conversation and embark on a journey toward IT
									success together.
								</p>
							</div>
