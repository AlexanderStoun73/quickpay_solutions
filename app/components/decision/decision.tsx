        ...
        <div>
          <article className={styles.card}>
            <span className={styles.icon}>
              <WidgetsIcon style={{ color: "#fff" }} className={styles.svg} />
            </span>
          ...
          <article className={styles.card}>
            ...
            <p className={styles.card_desc}>
              Embark on a journey with us as we strive for excellence, aiming to
              achieve award-winning status in delivering exceptional
              products/services
            </p>
          </article>
        </div>
        <div className={styles.centered_image}>
          <Image width={272} height={350} src={david} alt="" loading="lazy" />
        </div>
        <div>
          <article className={styles.card}>
            <span className={styles.icon}>
